...
<form action="insert" method="post">
 <table border="1" >
    ...
    <tr><td>Boss select</td>
    <td><select name='bossname'>
    <option value="bossa">자쿰</option>
    <option value="bossb">상빈</option></select></td></tr>
	<tr>
    <td>난이도선택</td>
    <td><select name='level'>
    <option value="easy">쉬움</option>
    <option value="nomal">보통</option>
    <option value="hard">어려움</option></select></td></tr>
    <tr><td>생성자 이메일</td><td><input type="text"name="email" value="duaitbank.com"></td></tr>
	<tr><td>캐릭터이름</td><td><input type="text"name="character" value="기사"></td></tr>
	</table>
