	...
	<div class="div_main_mid">
		<table class="table" id="modalItem" style="table-layout: fixed">
			<ul class="list-group list-group-flush">
				...
				<tr>
					<td><c:forEach items="${calcBoss}" var="calcBoss"
							varStatus="loop">
				...
				<tr>
					<td><c:forEach items="${calcMember}" var="calcMember"
							varStatus="loop">
				...
				<tr>
					<td><c:forEach items="${pgiList}" var="pgiList"
							varStatus="loop">
					...
					<td><c:forEach items="${pgiList}" var="pgiList"
							varStatus="loop">
							<li class="list-group-item list-group-item-action">
								${pgiList.itemSalePrice}</li>
						</c:forEach></td>
				</tr>
				<tr>
					<td>
						<li class="list-group-item list-group-item-action">총 합 (수수로
							5% 적용) :</li>
					</td>
					<td>
						<li class="list-group-item list-group-item-action">${price}</li>
					</td>
				</tr>
			</ul>
		</table>
