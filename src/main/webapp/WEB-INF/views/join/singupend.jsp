...
<body>
	...
	<div class="div_signend_main">
		<div class="div_signend_slide">
			<div class="container">
				<div id="demo" class="carousel slide" data-ride="carousel">
					<div class="carousel-inner">
						...
						<div class="carousel-item active">
							<!--가로-->
							<img class="d-block w-100" style="width: 300px; height: 300px;"
								src="${pageContext.request.contextPath}../resources/tagImage/maple1.jpg"
								alt="First slide">
							<div class="carousel-caption d-none d-md-block"></div>
						</div>
						<div class="carousel-item">
							<img class="d-block w-100" style="width: 300px; height: 300px;"
								src="${pageContext.request.contextPath}../resources/tagImage/maple2.jpg"
								alt="Second slide">
						</div>
						<div class="carousel-item">
							<img class="d-block w-100" style="width: 300px; height: 300px;"
								src="${pageContext.request.contextPath}../resources/tagImage/maple3.jpg"
								alt="Third slide">
						</div>
						<!-- / 슬라이드 쇼 끝 -->
					...
					<div class="modal-dialog modal-sm" role="document">
						<div class="modal-content">
							...
							<div class="modal-footer">		
								...
								<div class="div_signupend_modalButton">
									<button type="button" class="btn btn-dark" data-dismiss="modal"
										onclick="moveHome()">Main Page</button>
								</div>
							</div>
						</div>
					</div>
