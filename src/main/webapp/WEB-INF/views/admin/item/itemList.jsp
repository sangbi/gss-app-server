...
<body>
	...
	<div class="div_hr">
		...
		<h4 class="text-muted">ADMIN ADMIN</h4>
		<hr class="border-3 opacity-75">
	</div>
	<div class="div_admin_itemList">
				...
				<c:forEach var="itemList" items="${itemList}" varStatus="loop">
					<tr>
						<td style="vertical-align: middle"><a
							href=<c:url value="/admin/selectItem?itemName=${itemList.itemName}&classification=${itemList.classification}"/>>
								${itemList.itemName}</a></td>
						<td style="vertical-align: middle">${itemList.classification}</td>
						<td><div class="select_img">
								<img
									src="${pageContext.request.contextPath}/${itemList.itemImagepath}"
									width="50" height="50">
							</div></td>
					</tr>
				</c:forEach>
		...
		<a href="/admin/main"><input type="button" class="btn btn-dark"
			value="목록"></a> <a href="/admin/addItem"><input type="button"
			class="btn btn-dark" value="추가"></a>
	</div>
	<!-- paging -->
		...
		<ul class="pagination justify-content-center">
			...
			<c:if test="${page ne 1 }">
				<li class="page-item"><a class="page-link"
					href="${pageContext.request.contextPath }/admin/item?page=${page-1 }">&laquo;</a></li>
			</c:if>
				...
				<c:choose>
					<c:when test="${page eq i}">
						...
						<li class="page-item active"><a class="page-link"
							href="${pageContext.request.contextPath }/admin/item?page=${i }">${i}</a></li>
					</c:when>
					<c:otherwise>
						<li class="page-item"><a class="page-link"
							href="${pageContext.request.contextPath }/admin/item?page=${i }">${i}</a></li>
			...
			<c:if test="${page ne end }">
				<li class="page-item"><a class="page-link"
					href="${pageContext.request.contextPath }/admin/item?page=${page+1 }">&raquo;</a></li>
			</c:if>
		</ul>
	</nav>
	<!-- paging -->
