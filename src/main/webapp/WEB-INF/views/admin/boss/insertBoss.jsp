...
<c:import url="${pageContext.request.contextPath}/main/nav"></c:import>
	<div class="div_admin_insertBoss">
		<form:form modelAttribute="BossDto" method="POST" enctype="multipart/form-data" onsubmit="return check()">
			...
			<tr>
				<th>보스이름</th>
				<td><input type="text" class="form-control form-control-sm" name="bossName"></td>
			</tr>
			<tr>
				<th>난이도</th>
				<td><select name="bossGrade" class="form-select form-select-sm" aria-label=".form-select-sm example" style="width:260px; text-align:left">
			...
			<tr>
				<th>보스 이미지</th>
				<td>
				<input type="file" name="bossImagepath" id="input-image"class="hidden"value=""></td>
			</tr>
			</table>
			<input type="submit" class="btn btn-dark" value="등록">
			<a href="/admin/boss"><input type="button" class="btn btn-dark" value="뒤로가기"></a>
		</form:form>
	</div>
